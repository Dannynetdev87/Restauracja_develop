        ...
        @if(auth()->user()->isManager())
            <section id="stoliki" class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center border-b border-brand-dark/10 pb-6 mb-8">
                    ...
                    <a href="{{ route('manager.tables.index') }}" class="mt-4 sm:mt-0 bg-brand-dark text-brand-light hover:bg-brand-accent font-bold px-5 py-2.5 rounded-xl transition-all duration-200 ease-out shadow-sm text-sm flex items-center gap-2 hover:shadow-md active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-accent/40">
