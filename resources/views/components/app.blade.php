...
@guest
    <footer class="bg-brand-dark text-brand-light/80 border-t border-white/5 mt-auto">
        <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 items-start pb-8 border-b border-white/10">

                <div class="space-y-2">
                    <span class="text-white font-black tracking-tight text-xl">
                        Smak<span class="text-brand-accent">Przeszłości</span>
                    </span>
                    <p class="text-xs text-brand-light/60 leading-relaxed max-w-sm mt-2">
                        Tradycyjne receptury podane w nowoczesnej formie. Dbamy o najwyższą jakość składników i niepowtarzalną atmosferę.
                    </p>
                </div>

                <div class="flex flex-col items-center justify-center w-full">
                    <div class="w-full h-56 rounded-xl overflow-hidden shadow-sm border border-white/10">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2564.0579242229696!2d22.671087476808744!3d50.010269518959646!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x473c9bc687dd4e2f%3A0x1e439e2250d349f3!2sPANS%20im.%20ks.%20B.%20Markiewicza.%20Instytut%20Humanistyczny!5e0!3m2!1spl!2spl!4v1780909364060!5m2!1spl!2spl" width="400" height="200" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                    <span class="text-[10px] text-brand-light/40 mt-2 tracking-wide uppercase">Nasza lokalizacja</span>
                </div>

                <div class="w-full flex flex-col items-start md:items-end">
                    <div class="md:text-right">
                        <h3 class="text-white font-bold text-sm uppercase tracking-wider mb-3">Nawigacja</h3>
                        <ul class="space-y-2 text-xs mb-4">
                            <li>
                                <a href="{{ route('home') }}" class="hover:text-brand-accent transition">Strona główna</a>
                            </li>
                            <li>
                                <a href="{{ route('menu.index') }}" class="hover:text-brand-accent transition">Nasze Menu</a>
                            </li>
                            <li>
                                <a href="{{ route('about') }}" class="hover:text-brand-accent transition">O nas</a>
                            </li>
                        </ul>
                    </div>

                    <div class="flex items-center gap-2 mt-4">
                        <a href="#" class="w-9 h-9 rounded-lg bg-white/5 flex items-center justify-center text-brand-light hover:bg-brand-accent hover:text-brand-dark transition" title="Facebook">
                            <svg class="w-5 h-5" style="fill: currentColor; width: 20px; height: 20px;" viewBox="0 0 24 24">
                                <path d="M9 8H7v3h2v9h3v9h4v-9h3l.5-3H16V8c0-.5.5-1 1-1h2V4h-3a4 4 0 0 0-4 4v2H9V8z"/>
                            </svg>
                        </a>
                        <a href="#" class="w-9 h-9 rounded-lg bg-white/5 flex items-center justify-center text-brand-light hover:bg-brand-accent hover:text-brand-dark transition" title="Instagram">
                            <svg class="w-5 h-5" style="fill: currentColor; width: 20px; height: 20px;" viewBox="0 0 24 24">
                        ...
                        <a href="#" class="w-9 h-9 rounded-lg bg-white/5 flex items-center justify-center text-brand-light hover:bg-brand-accent hover:text-brand-dark transition" title="TikTok">
                            <svg class="w-5 h-5" style="fill: currentColor; width: 20px; height: 20px;" viewBox="0 0 24 24">
            ...
            <div class="pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-brand-light/40">
                <div>
...
@else
    <footer class="bg-brand-dark text-brand-light/40 border-t border-white/5 mt-auto py-4 px-4 sm:px-6 lg:px-8">
