    ...
    <section class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div class="mb-8 flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
            <div>
                ...
                <h1 class="mt-2 text-3xl font-black text-brand-dark">Napoje do przygotowania</h1>
                <p class="mt-2 max-w-3xl text-brand-accent">
                    Widok obejmuje tylko pozycje menu przypisane do baru. Każda zmiana statusu zapisuje się w historii pozycji.
                </p>
            </div>
        </div>
