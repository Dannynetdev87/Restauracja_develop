...
<section
    id="production-dashboard-refresh"
    ...
    <div class="rounded-lg border border-brand-dark/15 bg-white p-6 shadow-sm lg:p-8">
        <div class="mb-8 border-b border-brand-dark/10 pb-6">
            ...
            <div class="mt-2 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
                ...
                <span data-refresh-indicator class="w-fit rounded-md bg-brand-light px-3 py-1 text-xs font-bold text-brand-dark">
                    Odświeżanie co 8 s
                </span>
            </div>
                                    ...
                                    <article class="rounded-lg border border-brand-dark/10 bg-white p-4 shadow-sm">
                                        ...
                                        <div class="space-y-4">
                                            @foreach($orderItems as $item)
                                                ...
                                                <section class="rounded-lg border border-brand-dark/10 bg-brand-card p-4">
