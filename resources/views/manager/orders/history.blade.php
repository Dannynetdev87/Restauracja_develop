<x-app>
    ...
    <section class="w-full max-w-7xl mx-auto px-4 py-10 sm:px-6 lg:px-8">
        <div class="mb-8 flex flex-col items-start justify-between border-b border-brand-dark/10 pb-6 sm:flex-row sm:items-center">
            <div>
            ...
            <a href="{{ route('manager.dashboard') }}"
               class="mt-4 inline-flex rounded-md border border-brand-dark/20 bg-white px-4 py-2 text-sm font-bold text-brand-dark hover:bg-brand-light sm:mt-0">
                Wróć do dashboardu
            </a>
        </div>

        <form method="GET" action="{{ route('manager.orders.history') }}" class="mb-6 grid gap-4 rounded-xl border border-brand-dark/15 bg-white p-5 shadow-sm md:grid-cols-5">
            <div>
            ...
            <div>
                ...
                <select id="waiter_id" name="waiter_id" class="mt-1 w-full rounded-md border border-brand-dark/20 bg-white px-3 py-2 text-sm text-brand-dark focus:border-brand-dark focus:outline-none">
            ...
            <div>
                ...
                <select id="restaurant_table_id" name="restaurant_table_id" class="mt-1 w-full rounded-md border border-brand-dark/20 bg-white px-3 py-2 text-sm text-brand-dark focus:border-brand-dark focus:outline-none">
