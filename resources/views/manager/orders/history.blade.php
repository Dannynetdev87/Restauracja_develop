    ...
    <section class="w-full max-w-7xl mx-auto px-4 py-10 sm:px-6 lg:px-8">
        ...
        <form method="GET" action="{{ route('manager.orders.history') }}" class="mb-6 grid min-w-0 gap-4 rounded-xl border border-brand-dark/15 bg-white p-4 shadow-sm sm:p-5 md:grid-cols-5">
            ...
            <div class="flex items-end">
                <button type="submit" class="w-full rounded-md bg-brand-dark px-4 py-2 text-sm font-bold text-brand-light transition-all duration-200 ease-out hover:bg-brand-accent hover:shadow-md active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-accent/40">
                    Filtruj
                </button>
            </div>
        </form>
