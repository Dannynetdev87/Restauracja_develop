...
class KitchenDashboardController extends Controller
{
    ...
    {
        return [
            OrderItem::STATUS_NEW => 'Nowe',
            OrderItem::STATUS_PREPARING => 'W przygotowaniu',
            OrderItem::STATUS_READY => 'Gotowe',
            OrderItem::STATUS_DELIVERED => 'Dostarczone',
            OrderItem::STATUS_CANCELLED => 'Anulowane',
        ];
    }
}
